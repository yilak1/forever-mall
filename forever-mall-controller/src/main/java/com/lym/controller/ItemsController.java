...
import com.lym.pojo.vo.ItemInfoVO;
...
public class ItemsController extends BaseController{
    ...
    @ApiOperation(value = "根据商品id展示商品的详细信息", notes = "根据商品id展示商品的详细信息", httpMethod = "GET")
    @GetMapping("/info/{itemId}")
    public IMOOCJSONResult info(
            @ApiParam(name = "itemId", value = "商品的id", required = true)
    ...
    @ApiOperation(value = "根据商品id展示商品评价等级", notes = "根据商品id展示商品评价等级", httpMethod = "GET")
    ...
    public IMOOCJSONResult search(
            @ApiParam(name = "keysords", value = "关键字", required = true)
    ...
    @ApiOperation(value = "根据三级分类搜索商品", notes = "根据三级分类字搜索商品", httpMethod = "GET")
    @GetMapping("/catItems")
    ...
    //由于用户长时间没有登陆网站，刷新购物车中的数据，主要是商品价格。类似京东
    @ApiOperation(value = "更新cookie中的商品数据", notes = "更新cookie中的商品数据 notes", httpMethod = "GET")
    @GetMapping("/refresh")
    public IMOOCJSONResult refresh(
            @ApiParam(name = "itemSpecIds", value = "表示待更新的商品规格id组成的String", required = true, example = "1001,1002,1003")
